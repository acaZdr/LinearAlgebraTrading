...
class TestCalculateIndicators(unittest.TestCase):
    ...
    def test_empty_dataframe(self):
        ...
        os.remove(empty_csv)
        expected_columns = ['date', 'Open', 'High', 'Low', 'Close', 'Volume', 'SMA_10', 'SMA_50', 'EMA_20', 'RSI_14',
                            'MACD', 'BB_High', 'BB_Low', 'ATR_14']
        self.assertTrue(all(column in result_df.columns for column in expected_columns),
                        "All expected columns should be present in the result DataFrame")
    ...
    def test_output_structure(self):
        ...
        expected_order = ['date', 'Open', 'High', 'Low', 'Close', 'Volume', 'SMA_10', 'SMA_50', 'EMA_20', 'RSI_14',
                          'MACD', 'BB_High', 'BB_Low', 'ATR_14']
